...
//
//     final umaModel = umaModelFromJson(jsonString);

import 'dart:convert';

List<UmaModel> umaModelFromJson(String str) => List<UmaModel>.from(json.decode(str).map((x) => UmaModel.fromJson(x)));

String umaModelToJson(List<UmaModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class UmaModel {
    ...
    factory UmaModel.fromJson(Map<String, dynamic> json) => UmaModel(
